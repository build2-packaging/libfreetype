/* Note: The only differences between this file and the upstream version
 *       (ftoption.h.orig) are the definitions of FT_CONFIG_OPTION_SYSTEM_ZLIB
 *       and FT_CONFIG_OPTION_USE_PNG. Debian Bullseye's version is identical
 *       to ours except that they also define FT_CONFIG_OPTION_USE_BROTLI.
 */
